...
abs_deca_dir = os.path.abspath('/data/vision_team/Multiview_DECA')
...
# ---------------------------------------------------------------------------- #
cfg.dataset = CN()
cfg.dataset.training_data = ['celebvhq', 'voxceleb', 'mead']
# cfg.dataset.training_data = ['ethnicity']
cfg.dataset.eval_data = ['celebvhq', 'voxceleb', 'mead']
cfg.dataset.test_data = ['celebvhq', 'voxceleb', 'mead']
cfg.dataset.batch_size = 2
cfg.dataset.K = 4
cfg.dataset.isSingle = False
cfg.dataset.num_workers = 6
